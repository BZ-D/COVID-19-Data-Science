...
def go():
    ...
    browser.get('https://weibo.com/cctvxinwen?is_all=1&stat_date=202005&page=')
    sleep(30)  # 手动登录微博
    sumpage = 38

    for page in range(1, sumpage + 1):
        browser.get('https://weibo.com/cctvxinwen?is_all=1&stat_date=202005&page=' + str(page))
        sleep(7)
